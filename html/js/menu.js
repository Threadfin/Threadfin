...
function setMenuItem() {
  ...
  menu_filesUpdate["_usage"] = "Playlists and XMLTV files are updated by Threadfin at system startup."
  ...
  menu_xepg["_configKey"] = "ThreadfinAutoUpdate";
  menu_xepg["_label"] = "Automatic update of Threadfin";
  menu_xepg["_headline"] = "Automatic update of Threadfin";
  menu_xepg["_usage"] = "If a new version of Threadfin is available, it will be automatically installed."
  menu_xepg["name"] = "ThreadfinAutoUpdate";
  menu_xepg["id"] = "ThreadfinAutoUpdate";
  ...
  menu_autoBackupPath["_usage"] = "Before any update of the provider data by the schedule, Threadfin creates a backup. The path for the automatic backups can be changed. Threadfin requires write permission for this folder."
  ...
  menu_buffer["_usage"] = "With activated buffer, streams can be played and recorded more fluently.<br>The stream is passed from Threadfin to Plex / Emby"
  ...
  menu_api["_usage"] = 'Via API interface it is possible to send commands to Threadfin. API documentation is available <a href="https://threadfin.de?scroll=api">here</a> '
  //menu_api["_usage"]        = 'Via API interface it is possible to send commands to Threadfin. API documentation is available <a href="http://localhost:1313?scroll=api">here</a> '
  menu_api["name"] = "api";
  menu_api["id"] = "api";
  ...
  menu_authenticationWeb["_usage"] = "Access to Threadfin requires authentication."
  ...
  menu_authenticationPms["_usage"] = "Plex requests are only possible with authentication.<br>Warning!!! After activating this function Threadfin must be delete in the PMS DVR settings and set up again."
...
function openSubMenu(item) {
  ...
  if (item["_configKey"] == "settings") {
    ...
    newEntry["onclick"] = "ThreadfinBackup()"
    div.appendChild(createElement(newEntry));
  }
  ...
  if (item["_configKey"] == "settings") {
    ...
    newEntry["onclick"] = "ThreadfinRestore(this)"
    div.appendChild(createElement(newEntry));
  }
