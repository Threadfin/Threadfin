...
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.general}}", "ThreadfinAutoUpdate,tuner,epgSource,epgCategories,epgCategoriesColors,api"));
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.files}}", "httpThreadfinDomain,forceHttps,httpsPort,httpsThreadfinDomain,update,files.update,temp.path,cache.images,xepg.replace.missing.images,xepg.replace.channel.title,enableNonAscii"));
