...
function openPopUp(dataType, element) {
  ...
  switch (dataType) {
    case "playlist":
      ...
      // Type
      var text: string[] = ["M3U", "HDHomeRun", "{{.playlist.xtream.title}}"]
      var values: string[] = ["javascript: openPopUp('m3u')", "javascript: openPopUp('hdhr')", "javascript: openPopUp('xtream')"]
    ...
    case "xtream":
      ...
      // Passwort
      var dbKey: string = "xtream.password"
      ...
      // Output format
      var text: string[] = ["MPEG-TS", "HLS", "TS"]
      var values: string[] = ["mpegts", "hls", "ts"]
      ...
      // Tuner
      var tunerText: string[] = new Array()
      var tunerValues: string[] = new Array()
