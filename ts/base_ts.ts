...
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.streaming}}", "buffer,udpxy,buffer.size.kb,storeBufferInRAM,buffer.timeout,streaming.timeout,user.agent,ffmpeg.path,ffmpeg.options,vlc.path,vlc.options"))
